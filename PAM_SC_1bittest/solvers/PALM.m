...
function [Xnew,rankX,obj] = PALM(Mstar,U,V,y,ybar,f,fprime,spidx,OPTIONS,pars,lambda,mu)
...
[~,gradU] = funU(V,y,ybar,spidx,f,fprime,nr,nc,Xold);
...
for iter = 1:maxiter  
  ...
  %% ****************** to compute Vnew **************************
    ...
    [~,gradV] = funV(Unew,y,ybar,spidx,f,fprime,nr,nc,UnewVt);     
...
%% ******************** Optimality checking ************************
    ...
    [Loss,gradU] = funUV(Unew,Vnew,y,ybar,spidx,f,fprime,nr,nc,Xnew);
