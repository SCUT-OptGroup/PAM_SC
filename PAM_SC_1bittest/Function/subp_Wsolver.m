%% This file is to solve the proximal mapping of Lq norm, where q \in [0,1]

function xopt = subp_Wsolver(g, lambda, tau, q)
...
%         if abs(term_old - term_new)<1.0e-5
%             break;
%         end
        term_old = term_new;
